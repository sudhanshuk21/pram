  ...
  const data = [
    {
      title: "Who Am I",
      content:
        "I am Prabuddha Singh.I have forever been intrigued by flying object and have had a hooby of building them on my own. This is what pursued me to study aerospace and built multiple planes and drones hands on.",
      key: "",
    },
    {
      title: "Skills & Tools",
      content: "Design: Labview,xflr5,Fusion360,Photoshop",
      key: "Development: C,C++,Python",
    },
  ];
  return (
